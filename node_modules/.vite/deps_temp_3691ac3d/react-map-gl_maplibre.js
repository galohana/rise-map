...
var Maplibre = class _Maplibre {
  ...
  _updateStyleComponents({ light, projection, sky, terrain }) {
    ...
    if ((_a = map.style) == null ? void 0 : _a._loaded) {
      if (light && !deepEqual(light, currProps.light)) {
        currProps.light = light;
        map.setLight(light);
      }
      if (projection && !deepEqual(projection, currProps.projection) && projection !== ((_b = currProps.projection) == null ? void 0 : _b.type)) {
        currProps.projection = typeof projection === "string" ? { type: projection } : projection;
        (_c = map.setProjection) == null ? void 0 : _c.call(map, currProps.projection);
      }
...
function _Map(props, ref) {
  ...
  (0, import_react3.useEffect)(() => {
    ...
    let isMounted = true;
    let maplibre;
    Promise.resolve(mapLib || import("./maplibre-gl-ILVGZVQK.js")).then((module) => {
      if (!isMounted) {
        return;
      }
      if (!module) {
